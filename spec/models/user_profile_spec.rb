...
RSpec.describe UserProfile, type: :model do
  ...
  describe "validations" do
    ...
    it "allows nil org_member_id" do
      profile = build(:user_profile, org_member_id: nil)
      expect(profile).to be_valid
    end

    context "org_member_id uniqueness" do
      let!(:existing_profile) { create(:user_profile, org_member_id: "ABC123") }
      let(:duplicate_profile) { build(:user_profile, org_member_id: "ABC123") }
